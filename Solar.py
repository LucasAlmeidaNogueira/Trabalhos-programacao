...
Terra=Planet((WIDTH/2)+300,HEIGHT/2,20,BLUE,10)
Sol=Planet(WIDTH/2,HEIGHT/2,20,RED,10)
Mercurio=Planet((WIDTH/2)+100,(HEIGHT/2),20,YELLOW,10)
Venus=Planet((WIDTH/2)+200,HEIGHT/2,20,RED,10)

Mercurio.distance_to_sun=math.sqrt((Mercurio.x-Sol.x)**2+(Mercurio.y-Sol.y)**2)
...
while running:
    ...
    Vacuo=pygame.draw.rect(WIN,BLACK,(0,0,HEIGHT,WIDTH))
    pygame.draw.circle(WIN,Sol.color,(Terra.x,Terra.y),Sol.radius)
